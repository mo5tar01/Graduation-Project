...
class RecommendationDetailsScreen extends StatefulWidget {
  final Map<String, dynamic> recommendationItem;

  RecommendationDetailsScreen({required this.recommendationItem});

  @override
  _RecommendationDetailsScreenState createState() => _RecommendationDetailsScreenState();
}

class _RecommendationDetailsScreenState extends State<RecommendationDetailsScreen> with TickerProviderStateMixin {
            ...
            Column(
              children: <Widget>[
                AspectRatio(aspectRatio: 1,
                  child: Image.network(
                    widget.recommendationItem['Image'],
                    fit: BoxFit.cover,
                  ),
                ),
              ],
                      ...
                      child: Column(
                        ...
                        children:<Widget> [
                          Padding(
                            ...
                            child: Text(
                              widget.recommendationItem['Name'],
                          ...
                          AnimatedOpacity(
                            ...
                            child: Padding(
                              ...
                              child: SingleChildScrollView(
                                ...
                                child: Row(
                                  children: <Widget>[
                                    getTimeBoxUI(widget.recommendationItem['numReviews'].toString(),'Reviews'),
                                    getTimeBoxUI(widget.recommendationItem['subType'],'Category'),
                                    getTimeBoxUI(widget.recommendationItem['rankingPosition'].toString(),'Ranking Position'),
                                  ],
                                ),
                              ),
                            ),
  ...
  void saveDetailsToDatabase() async {
    ...
    try {
      ...
      Map<String, dynamic> newBucketListItem = {
        'name': widget.recommendationItem['Name'],
        'city': widget.recommendationItem['cityAddress'],
        'country': widget.recommendationItem['countryAddress'],
        'imageURL': widget.recommendationItem['Image'],
        'rating': widget.recommendationItem['Rating'],
        'description': ' ',
        'subCategory': widget.recommendationItem['subCategory'],
        'subType': widget.recommendationItem['subType'],
        'rawRanking': widget.recommendationItem['rawRanking'],
        'rankingDenominator': widget.recommendationItem['rankingDenomirator'],
        'rankingPosition': widget.recommendationItem['rankingPosition'],
        'numReviews': widget.recommendationItem['numReviews'],
      };
